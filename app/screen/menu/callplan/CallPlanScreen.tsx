...
type NavigationProp = StackNavigationProp<CallPlanParamList, 'CallPlan'>;
export default function CallPlanScreen() {
    const navigation = useNavigation<NavigationProp>();
    const menuItems = [
        { title: "Dashboard", icon: 'speedometer-outline' },
        { title: "Purchases", icon: 'cart-outline' },
        { title: "Jomlyy", icon: 'cart-outline' },
    ];
        ...
        <View style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.menuContainer}>
                <View style={styles.activitiesHeader}>
                    <Text style={styles.activitiesHeaderText}>Call Plan &gt; Menu</Text>
                </View>
